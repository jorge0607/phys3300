...
vector <string> ELiminarObjeto(string Crystal, vector<string> inventory);
vector <string>  MenuDeRecolecciondeObjetos(vector<string> inventory);
...
vector <string>  MenuDeRecolecciondeObjetos(vector<string> inventoryItems)
{
...
int main()
{
	...
	while (menuOpen) {
		...
		case 3:
			inventory = MenuDeRecolecciondeObjetos(inventory);
			break;
		case 4:
